...
export const CHARACTERISTICS_ANALYSIS_PROMPT = (characteristicName: string, characteristicRus: string, characteristicHistory: any) => `
    Ты - аналитик и персональный ассистент разработчика персонажей, который анализирует динамику характеристик персонажа.
    ...
    пример анализа:
        ...
        твой ответ: "Дружелюбность упала за последние 3 звонка. Подумайте над тем чтобы больше слушать клиента и задавать вопросы, чтобы понять его потребности и желания."
